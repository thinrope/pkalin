...
IUSE_PROGRAMMERS="atahpt +atapromise +atavia +buspirate_spi +ch341a_spi +dediprog
+developerbox_spi +digilent_spi +drkaiser +dummy +ft2232_spi +gfxnvidia +internal
+it8212 +linux_mtd +linux_spi mstarddc_spi +nic3com +nicintel +nicintel_eeprom
...
LIB_DEPEND="atahpt? ( sys-apps/pciutils[static-libs] )
	...
	ch341a_spi? ( >=virtual/libusb-1-r3[static-libs] )
	dediprog? ( >=virtual/libusb-1-r3[static-libs] )
	developerbox_spi? ( >=virtual/libusb-1-r3[static-libs] )
	digilent_spi? ( >=virtual/libusb-1-r3[static-libs] )
	pickit2_spi? ( >=virtual/libusb-1-r3[static-libs] )
