...
SRC_URI="https://gitlab.com/CrimsonNape/oscar-sql/-/archive/v${PV}/oscar-sql-v${PV}.tar.bz2"
S="${WORKDIR}/oscar-sql-v${PV}"
...
DEPEND="
	virtual/opengl
	x11-libs/libX11
	dev-qt/qtbase:6[gui,opengl,widgets,sql,sqlite]
